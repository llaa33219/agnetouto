...
```python
class Router:
    def __init__(agents, tools, providers, *, run_agents=None, disabled_tools=None)
...
```python
class Runtime:
    def __init__(router, debug=False, extra_instructions=None, extra_instructions_scope="entry", on_message=None)
